		...
		return (
			<div>
				...
				<div id="sign-in" className="instructions">
					...
					<button id="login-button" className="ui basic button centered" onClick={this.props.login}>
						<i className="twitter icon" />
						<p>Sign in with Twitter</p>
					</button>
					<br />
					<button id="dummy-button" className="ui basic button centered" onClick={this.props.dummy}>
						<i className="twitter icon" />
						<p>Dummy Profile</p>
					</button>
				</div>
