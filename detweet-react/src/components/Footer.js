		...
		<footer>
			<div className="ui center aligned container">
				<div className="follow-div">
					...
					<a
						href="https://twitter.com/detweet_app?ref_src=twsrc%5Etfw"
					...
					<a
						href="https://twitter.com/rglatzell?ref_src=twsrc%5Etfw"
						className="twitter-follow-button"
						data-show-count="false"
					>
						Follow @rglatzell
					...
					<script async src="https://platform.twitter.com/widgets.js" charSet="utf-8" />
					<a
						href="https://twitter.com/hemant_heer?ref_src=twsrc%5Etfw"
						className="twitter-follow-button"
						data-show-count="false"
					>
						Follow @hemant_heer
